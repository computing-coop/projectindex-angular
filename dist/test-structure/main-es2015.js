...
let LeftFooterComponent = class LeftFooterComponent {
...
LeftFooterComponent.ctorParameters = () => [
...
ProjectDescriptionComponent.ctorParameters = () => [
    { type: _project_service__WEBPACK_IMPORTED_MODULE_2__["ProjectService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
let ProjectService = class ProjectService {
    ...
    getProject(root) {
        return this.getProjects()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((projects) => projects.find(p => p.imgRoot === root)));
    }
    handleError(err) {
        let errorMessage = '';
...
let StartImagesComponent = class StartImagesComponent {
    constructor() {
        this.aboutimgs = [];
    }
    ngOnInit() {
...
let StaticImgComponent = class StaticImgComponent {
    constructor() { }
    ngOnInit() {
    }
};
